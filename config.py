...
STATUS_MAP = {
    ...
    "Ready for Development": {"label": "Ready to Dev", "color": "#eab308", "order": 1},
    "In Progress": {"label": "In Progress", "color": "#3b82f6", "order": 2},
    "In Review": {"label": "On Review", "color": "#f97316", "order": 3},
